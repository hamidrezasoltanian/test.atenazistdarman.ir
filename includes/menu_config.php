...
return [
    ...
    // ─── کیفیت ISO 13485 ───
    ['type' => 'separator', 'title' => 'کیفیت ISO 13485'],

    [
        'title' => 'مدیریت کیفیت (QMS)',
        'link'  => '#',
        'icon_color' => '#dc2626',
        'perm'  => 'crm_view',
        ...
        'submenu' => [
            ...
            ['title' => 'یادآورهای QMS',             'link' => 'admin/qms_reminders.php',  'perm' => 'admin'],
        ]
    ],
    ...
    // ─── واردات ───
    ['type' => 'separator', 'title' => 'واردات'],
    [
        'title' => 'مدیریت واردات',
        'link'  => 'admin/import_dashboard.php',
        'icon_color' => '#0ea5e9',
        'perm'  => 'inv_view',
