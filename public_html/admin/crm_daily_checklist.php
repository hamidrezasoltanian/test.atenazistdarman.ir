<?php
/*
 * فایل: public_html/admin/crm_daily_checklist.php
 * ماژول CRM — چک‌لیست روزانه (در دست توسعه)
 */
ob_start();
session_start();
...
<div id="mainContent" class="main-content">
  <div class="coming-soon-wrap">
    ...
    <div class="coming-soon-title">چک‌لیست روزانه</div>
